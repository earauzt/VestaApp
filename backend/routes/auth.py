...
from utils import get_current_user, check_role, verify_password, get_password_hash, create_access_token
...
async def register(user_data: UserCreate):
    ...
    return Token(
        ...
        token_type="bearer",
        user=UserResponse(id=user_id, email=user_data.email, name=user_data.name, role=user_data.role, created_at=user_doc["created_at"])
    )
